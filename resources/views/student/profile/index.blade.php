				...
				<form method="post" action="{{route('student.profile.update')}} " class="form-horizontal" enctype="multipart/form-data">
				  ...
				  <fieldset>
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" name="name" value="{{$student->name}}" class="span6 typeahead" id="typeahead">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" name="about" value="{{$student->about}}" class="span6 typeahead" id="typeahead">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" name="email" value="{{$student->email}}" class="span6 typeahead" id="typeahead">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input name="image" value="{{$student->image}}" class="input-file uniform_on" id="fileInput" type="file">
					  </div>
					</div>   
		...
		<div class="box span4">
			...
			<div class="box-content">
				<div class="masonry-gallery">
					<div id="image-1" class="masonry-thumb">
						<img class="grayscale" src="{{URL::asset('/studentprofile/'.$student->image)}} " alt="Sample Image 1">
					</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form method="post" action="{{route('student.password.update')}} " class="form-horizontal" enctype="multipart/form-data">
							@csrf
							@method('PUT')
						  <fieldset>
							<div class="control-group">
